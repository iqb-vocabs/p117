...
ID of profile: `https://raw.githubusercontent.com/iqb-vocabs/p117/master/unit.json`
...
ID of profile: `https://raw.githubusercontent.com/iqb-vocabs/p117/master/item.json`
...
| Anforderungsbereich | [Vokabular](https://w3id.org/iqb/v31/n1/) | url: 'https://w3id.org/iqb/v31/n1/', Einmalauswahl, Dialogbox, Nummerierung unterdrückt | s3 |
| Bildungsstandard MSA - primär | [Vokabular](https://w3id.org/iqb/v31/k1/) | url: 'https://w3id.org/iqb/v31/k1/', Einmalauswahl, Dialogbox | s5 |
| Bildungsstandards MSA - sekundär | [Vokabular](https://w3id.org/iqb/v31/k1/) | url: 'https://w3id.org/iqb/v31/k1/', Mehrfachauswahl, Dialogbox | s6 |
